...
// int updateUserStatusForFirstName(@Param("role") Integer status,
// @Param("fname") String fname);

// Native Update :
// @Modifying
// @Query(value = "update User u set u.status = ? where u.name = ?", nativeQuery
// = true)
// int updateUserStatusForFirstName1(Integer status, String name);

// @Modifying
// @Query(value = "insert into Users (firstName, lastName, role) values (:fn,
// :ln, :role)", nativeQuery = true)
// void insertUser(@Param("fn") String fn, @Param("ln") Integer ln,
