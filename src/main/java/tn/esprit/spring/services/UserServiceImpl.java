...
public class UserServiceImpl implements IUserService {
	...
	public User addUser(User u) {
		...
		try {
			...
			l.info("Out of Method addUser with Success " + u.getFirstName() + " " + u.getLastName());
	...
	public User updateUser(User u) {
		...
		try {
			...
			l.info("Out of Method updateUser with Success " + u.getFirstName() + " " + u.getLastName());
	...
	public User retrieveUser(String id) {
		...
		try {
			...
			l.info("Out of Method retrieveUser with Success " + u.getId());
